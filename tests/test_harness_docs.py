...
DOCUMENTS = (
    ...
    ".claude/skills/worldloom-improve/SKILL.md",
    ".claude/skills/worldloom-improve/references/loop-and-gates.md",
    ".claude/skills/worldloom-improve/references/agent-packs.md",
    ".claude/skills/worldloom-improve/references/failures-and-curriculum.md",
    ".claude/skills/worldloom-improve/references/grader-and-agreement.md",
    ".claude/skills/worldloom-improve/references/scale.md",
    ".claude/skills/worldloom-improve/references/training-data.md",
