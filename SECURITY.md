...
**[Report a vulnerability](https://github.com/vamsiramakrishnan/synthetic-foundry/security/advisories/new)**
...
- Code execution or path traversal while loading untrusted input: a corpus
  ...
  else the CLI parses. These files are the tool's attack surface — a user can
  reasonably be handed a corpus or a pack by someone else.
