...
insurer on thin margins in a fragmented market" belongs to. Two of them also
interact in a way nobody predicts: naming *any* facet settles *every* facet at
its registry default, so `--facet listing=listed` alone also asserts a flat
trading year, replacing the engine's 21% December.
