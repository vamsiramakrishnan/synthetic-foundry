...
- `purpose`: one sentence stating why this LOB exists.
...
refusals, and both exist because an edge to nothing reports as though real
accountability rode on it, when none does:
