...
starts from exactly the state your proposal was judged against. Fix those
...
- `references/loop.md` — driving a cascade from Python: the verbs, Session
  semantics, what a refusal costs, resume.
