...
evidence component. Native runs currently report unassigned splits and
`calibrated: false`; connector noise calibration does not certify native
reading difficulty. The native queryset is a separate export from the
