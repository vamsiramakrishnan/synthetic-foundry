...
### The gate is not passed, and here is the measurement

Seed 8128, incident forced, one period, baseline retriever at k=5. Left column
without actors, right with.
...
Recorded rather than fixed, because the fix is a change to what the episode
