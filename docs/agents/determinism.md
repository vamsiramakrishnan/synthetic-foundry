...
description: Prove a corpus regenerates from its own record with replay, verify, migrate, and the schema-bump policy.
...
is what its own record regenerates, and coherent. It makes no model
