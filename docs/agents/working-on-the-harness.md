...
description: Change the harness safely, knowing where things are, the docs gate, the determinism sweep, and the hardness readings.
...
states an exit gate for each step, and the ordering matters: several steps
