# Supplied vocabulary design (unverified input)

This is the supplied design, not a statement of implemented coverage or verified licences.
See `docs/process-catalogue.md` for the integration boundary and measured results.
